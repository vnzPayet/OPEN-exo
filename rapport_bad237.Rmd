...
```{r logo, echo=FALSE, out.width = '12%', fig.align = "center",fig.cap="Logo Rmarkdown"}
...
datatemp <- read.table(link, h=TRUE, sep=";", dec=".", row.names=1,
                       encoding="latin1")
...
```{r datatempville, echo = F, eval=T, fig.height = 6, fig.width = 6, fig.align = "center", fig.cap="Températures par villes\\label{fig:tempvilles}"}
villes2<-factor(villes,levels(villes)[order(med)])
boxplot(temp~villes2,las=2,col="grey",ylab="Températures mensuelles",cex.lab=0.9,cex.axis=0.7)
```
