...
author: "Groupe 2 : Louise ARSAC, Zélie FROMENT, Charlène LAROCHE, Paul SERVAIN, Axel FALIGOT-GIRARDELLI, Juliette MAYER" 
date: "29/04/20"
output:
  html_document:
    fig_caption: yes
...
```{r datatempville, echo = F, eval=T, fig.height = 20,fig.align = "center", fig.width = 60, fig.align = "center", fig.cap="Températures par villes\\label{fig:tempvilles}"}
villes2<-factor(villes,levels(villes)[order(med)])
boxplot(temp~villes2,las=3,col="grey",ylab="Températures mensuelles",cex.lab=3,cex.axis=3, xlab = "Villes")
```
&nbsp;
