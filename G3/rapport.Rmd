---
title: Températures dans les villes Françaises - Editions de rapports automatisés
  avec Rmarkdown.
author: "V Tolon"
...
datatemp<-read.table(link,h=T,sep=";",dec=".",row.names=1)
```
...
```{r datatempville, echo = F,eval=T,fig.height = 4, fig.width = 4.5, fig.align = "center",fig.cap="Températures par villes\\label{fig:tempvilles}"}
...
`r dd$Région[3]` | `r dd$Moyenne[3]` | `r dd$AmplitudeM[3]` 
`r dd$Région[4]` | `r dd$Moyenne[4]` | `r dd$AmplitudeM[4]` 
...
```{r valp, echo = T,eval=T,fig.cap="Valeurs propres",fig.height = 3, fig.width = 4,fig.align = "center"}
...
```{r indiv, echo = T,eval=T,fig.cap="Cercle des corrélations",fig.height =5 , fig.width = 5,fig.align = "center"}
