...
Pour gérer les fichiers présents dans son dépôt, on utilise l'invite de commande et on commence par créer une copie locale de notre dépôt. <br/> 
Pour cela on ouvre l'invite de commandes de notre ordinateur et on accède au lieu où l'on veut stocker notre dépôt par la commande cd :
