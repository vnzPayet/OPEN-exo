...
```{r graphtemp, echo = T,eval=T,fig.height = 4,fig.align = "center", fig.width = 4,fig.cap="Courbes de températures mensuelles par régions"}
#température moyenne
...
#Légende
legend(2,0,"Moyenne Régions",bty="n",col="red",lwd=2,cex=0.7)
```
