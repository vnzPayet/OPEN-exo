...
En outre, cela permet également de réduire les risques de suppression ou de déplacements malencontreux et donc de préserver l’intégrité des données (Pole_Donnees_de_la_Recherche IST, 2016).
